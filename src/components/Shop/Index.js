...
class Shop extends Component{
    ...
    var {_todoProduct,addToCart} = this.props
        console.log(_todoProduct._products); //{cart:[], numberCart : 0,_products:[{},..]}
    //get current post
    const indexOfLastPost = currentPage * postPerPage;
    const indexOfFirstPost = indexOfLastPost - postPerPage;
    const currentPost = _todoProduct._products.slice(indexOfFirstPost,indexOfLastPost);
    ...
    const filterByKeyword = _todoProduct._products.filter(product => {
    ...
    //PAGINATION
    const pageNumbers = [];
    var totalPosts = _todoProduct.length
                                ...
                                <form  id="search-form">
                                    ...
                                    <div className="col-12">
                                        ...
                                        <div className="col-lg-8 col-md-6 col-sm-12 p-0">
                                            <input type="text" onChange={this.onChange} placeholder="Search..." className="form-control" id="search" />
                                        </div>
